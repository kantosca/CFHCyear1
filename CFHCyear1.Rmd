...
summary(glm(sampdf$Shannon~sampdf$StatusAge+sampdf$dFeedingModeED))
...
ggplot(sampdf[sampdf$Status =="HC",], aes(Axis.1,Axis.2, color = TimePeriod)) +
  ...
  geom_point(data = HC1[1,], shape = 17, color = Pinks[1],size = 5)+
  geom_point(data = HC2[1,], shape = 17, color = Oranges[1],size = 5)+
  geom_point(data = HC3[1,], shape = 17, color = Purples[1],size = 5)+
  geom_point(data = HC4[1,], shape = 17, color = Reds[1],size = 5)
dev.off()
...
ggplot(sampdf[sampdf$Status =="HC",], aes(Axis.1,Axis.2, color = TimePeriod)) +
  ...
  geom_point(data = HC1[2,], shape = 17, color = Pinks[2],size = 5)+
  geom_point(data = HC2[2,], shape = 17, color = Oranges[2],size = 5)+
  geom_point(data = HC3[2,], shape = 17, color = Purples[2],size = 5)+
  geom_point(data = HC4[2,], shape = 17, color = Reds[2],size = 5)
dev.off()
...
ggplot(sampdf[sampdf$Status =="HC",], aes(Axis.1,Axis.2, color = TimePeriod)) +
  ...
  geom_point(data = HC1[3,], shape = 17, color = Pinks[3],size = 5)+
  geom_point(data = HC2[3,], shape = 17, color = Oranges[3],size = 5)+
  geom_point(data = HC3[3,], shape = 17, color = Purples[3],size = 5)+
  geom_point(data = HC4[3,], shape = 17, color = Reds[3],size = 5)
dev.off()
...
ggplot(sampdf[sampdf$Status =="HC",], aes(Axis.1,Axis.2, color = TimePeriod)) +
  ...
  geom_point(data = HC1[4,], shape = 17, color = Pinks[4],size = 5)+
  geom_point(data = HC2[4,], shape = 17, color = Oranges[4],size = 5)+
  geom_point(data = HC3[4,], shape = 17, color = Purples[4],size = 5)+
  geom_point(data = HC4[4,], shape = 17, color = Reds[4],size = 5)
dev.off()
...
ggplot(sampdf[sampdf$Status =="HC",], aes(Axis.1,Axis.2, color = TimePeriod)) +
  ...
  geom_point(data = HC1[5,], shape = 17, color = Pinks[5],size = 5)+
  geom_point(data = HC2[5,], shape = 17, color = Oranges[5],size = 5)+
  geom_point(data = HC3[5,], shape = 17, color = Purples[5],size = 5)+
  geom_point(data = HC4[5,], shape = 17, color = Reds[5],size = 5)
dev.off()
```
...
ggplot(CFsamp, aes(PC1,PC2, color = TimePeriod)) + 
  ...
  theme_bw(base_size = 25) +
  scale_color_manual(values = Blues, name = "Age")+
  geom_point(data = CF1[1,],shape = 17, color =   Pinks[1],size = 5)+
  geom_point(data = CF2[1,],shape = 17, color = Oranges[1],size = 5)+
  geom_point(data = CF3[1,],shape = 17, color = Purples[1],size = 5)+
  geom_point(data = CF4[1,],shape = 17, color =    Reds[1],size = 5)
...
ggplot(CFsamp, aes(PC1,PC2, color = TimePeriod)) + 
  ...
  geom_point(data = CF1[2,],shape = 17, color =   Pinks[2],size = 5)+
  geom_point(data = CF2[2,],shape = 17, color = Oranges[2],size = 5)+
  geom_point(data = CF3[2,],shape = 17, color = Purples[2],size = 5)+
  geom_point(data = CF4[2,],shape = 17, color =    Reds[2],size = 5)
dev.off()
...
ggplot(CFsamp, aes(PC1,PC2, color = TimePeriod)) + 
  ...
  geom_point(data = CF1[3,],shape = 17, color =   Pinks[3],size = 5)+
  geom_point(data = CF2[3,],shape = 17, color = Oranges[3],size = 5)+
  geom_point(data = CF3[3,],shape = 17, color = Purples[3],size = 5)+
  geom_point(data = CF4[3,],shape = 17, color =    Reds[3],size = 5)
dev.off()
...
ggplot(CFsamp, aes(PC1,PC2, color = TimePeriod)) + 
  ...
  geom_point(data = CF1[4,],shape = 17, color =   Pinks[4],size = 5)+
  geom_point(data = CF2[4,],shape = 17, color = Oranges[4],size = 5)+
  geom_point(data = CF3[4,],shape = 17, color = Purples[4],size = 5)+
  geom_point(data = CF4[4,],shape = 17, color =    Reds[4],size = 5)
dev.off()
...
ggplot(CFsamp, aes(PC1,PC2, color = TimePeriod)) + 
  ...
  geom_point(data = CF1[5,],shape = 17, color =   Pinks[5],size = 5)+
  geom_point(data = CF2[5,],shape = 17, color = Oranges[5],size = 5)+
  geom_point(data = CF3[5,],shape = 17, color = Purples[5],size = 5)+
  geom_point(data = CF4[5,],shape = 17, color =    Reds[5],size = 5)
dev.off()
